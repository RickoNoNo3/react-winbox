...
> NOTICE: This repo is now used to apply for [Codex for Open Source](https://openai.com/form/codex-for-oss/), using the email `hcdou63@gmail.com` associated with our ChatGPT account.
