...
var WinBox = /** @class */ (function (_super) {
    ...
    function WinBox(props) {
        ...
        _this.maintain = function (args) {
            ...
            var _j = args !== null && args !== void 0 ? args : {}, force = _j.force, prevProps = _j.prevProps;
            ...
            if (force
                ...
                _this.winBoxObj.width = _this.props.width;
                _this.winBoxObj.height = _this.props.height;
                (_e = _this.winBoxObj) === null || _e === void 0 ? void 0 : _e.resize(); // resize before move, see https://github.com/nextapps-de/winbox#chaining-methods
            }
            if (force
                ...
                _this.winBoxObj.x = _this.props.x;
                _this.winBoxObj.y = _this.props.y;
                (_f = _this.winBoxObj) === null || _f === void 0 ? void 0 : _f.move();
            }
            if (force
                ...
                _this.winBoxObj.top = _this.props.top;
                _this.winBoxObj.right = _this.props.right;
                _this.winBoxObj.bottom = _this.props.bottom;
                _this.winBoxObj.left = _this.props.left;
                (_g = _this.winBoxObj) === null || _g === void 0 ? void 0 : _g.move();
            }
            if (force || (prevProps === null || prevProps === void 0 ? void 0 : prevProps.url) !== _this.props.url) {
                (_h = _this.winBoxObj) === null || _h === void 0 ? void 0 : _h.setUrl(_this.props.url);
            }
